...
class RepairsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create repair" do
    assert_difference('Repair.count') do
      post repairs_url, params: { repair: { computer_tag: @repair.computer_tag, status: @repair.status, user_id: @repair.user_id } }
    end
  ...
  test "should update repair" do
    patch repair_url(@repair), params: { repair: { computer_tag: @repair.computer_tag, status: @repair.status, user_id: @repair.user_id } }
