...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { model_id: @computer.model_id, tag: @computer.tag, ticket: @computer.ticket } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { model_id: @computer.model_id, tag: @computer.tag, ticket: @computer.ticket } }
